package  {
	...
	public final class Conductor extends MovieClip {
		...
		// Center of the stage.
		public static var CENTER_X:Number;
		public static var CENTER_Y:Number;
		...
		private var musicPath:String = 'karaoke/what_is_love.mp3';
		...
		public function Conductor() {
			...
			INSTANCE = this;  // Singleton INSTANCE always points to the one and only implementation of the class. Allows this class ot be accessed anywhere in the program
			...
			mTimelineSprite 	= new TimelineSprite(mMainTimeline.getTimeSignatureData());
			mMetronome 			= new Metronome(CENTER_X, CENTER_Y, BEATS_PER_MEASURE);
			
			// Creates the music player
			mMusicPlayer = new MusicPlayer("what_is_love.mp3");
		...
		public function kittyKaraoke() : void {
		...
		/** Returns the singleton instance of this class (Root).*/
...
//			CenterFlower.repeat = -1;
		...
		private function onTimerUpdate( Evt:Event ) : void {
			...
			mTimelineSprite.setTotalObjectsTxt( mMainTimeline.currentTime );
